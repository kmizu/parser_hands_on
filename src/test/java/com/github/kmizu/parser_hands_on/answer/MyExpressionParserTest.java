...
public class MyExpressionParserTest {
    ...
    public void confirmAdditionIsParsed1() {
        assertEquals(new ExpressionNode.Addition(integer(1), integer(0)), parser.parse("1+0"));
        assertEquals(new ExpressionNode.Addition(integer(1), integer(1)), parser.parse("1+1"));
        assertEquals(new ExpressionNode.Addition(integer(1), integer(2)), parser.parse("1+2"));
